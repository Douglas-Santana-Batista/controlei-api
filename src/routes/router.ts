...
// import { createInstallments, deleteInstallment, getallInstallment, getinstallment } from "../controller/installmentsController";
// import { authMiddleware } from "../infrastructure/middlewares/authMiddleware";
// import { authorizeUser } from "../infrastructure/middlewares/authorizationMiddleware";
...
// router.delete("/deleteCategory/:id_user/:id_category", authMiddleware, authorizeUser, deleteCategory);
...
// router.delete("/deleteInstallment/:id_user/:id_subcategory", authMiddleware, authorizeUser, deleteInstallment);
// router.get("/getallInstallment/:id_user", authMiddleware, authorizeUser, getallInstallment);
