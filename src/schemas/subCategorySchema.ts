import { z } from "zod";
import { idSchema, stringSchema, MonetaryValueSchema, dateSchema, toUpperCase } from "./shared.schema";
...
export const subCategorybodySchema = z.object({
  ...
  payment_type: z.preprocess(toUpperCase, z.enum(["CREDITO", "DEBITO", "BOLETO", "PIX"])),
  financial_flow: z.preprocess(toUpperCase, z.enum(["ENTRY", "EXIT"])),
});
